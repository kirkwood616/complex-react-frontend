    ...
    switch (action.type) {
      ...
      case "emailAfterDelay":
        if (!/^\S+@\S+$/.test(draft.email.value)) {
          ...
          draft.email.message = "You must provide a valid e-mail address.";
        }
      ...
      case "passwordAfterDelay":
        ...
        return;
      case "submitForm":
        if (!draft.username.hasErrors && draft.username.isUnique && !draft.email.hasErrors) {
          draft.submitCount++;
        }
        return;
    }
      ...
      <div className="row align-items-center">
        <div className="col-lg-7 py-3 py-md-5">
          ...
          <p className="lead text-muted">
            Are you sick of short tweets and impersonal &ldquo;shared&rdquo; posts that are reminiscent of the late 90&rsquo;s email forwards? We believe getting back to
